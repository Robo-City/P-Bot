...
def create_menu():
    ...
    tk.Button(main_frame, text="Home", command=home_menu, height=5, width=10).grid(row=1, column=0, padx=10, pady=10)
    tk.Button(main_frame, text="Super Market", command=super_market_menu, height=5, width=10).grid(row=1, column=1, padx=10, pady=10)
    tk.Button(main_frame, text="Farm Mode", command=farm_menu, height=5, width=10).grid(row=1, column=2, padx=10, pady=10)
    tk.Button(main_frame, text="Disaster", command=disaster_menu, height=5, width=10).grid(row=1, column=3, padx=10, pady=10)
    tk.Button(main_frame, text="Food And Other", command=under_construction, height=5, width=10).grid(row=1, column=4, padx=10, pady=10)
    tk.Button(main_frame, text="Self Driven", command=under_construction, height=5, width=10).grid(row=2, column=1, padx=10, pady=10)
    tk.Button(main_frame, text="Mobile App", command=under_construction, height=5, width=10).grid(row=2, column=2, padx=10, pady=10)
    tk.Button(main_frame, text="PayLoad", command=pay_load, height=5, width=10).grid(row=2, column=3, padx=10, pady=10)
...
def home_menu():
    ...
    tk.Button(main_frame, text="PS4 Controller", command=lambda: set_mode("PS4_CONTROLLER"), height=5, width=10).grid(row=0, column=0, padx=10, pady=10)
    tk.Button(main_frame, text="Companion Mode", command=lambda: set_mode("COLOR_FOLLOW"), height=5, width=10).grid(row=0, column=1, padx=10, pady=10)
    tk.Button(main_frame, text="Free Roam", command=lambda: set_mode("FREE_ROAM"), height=5, width=10).grid(row=0, column=2, padx=10, pady=10)
    tk.Button(main_frame, text="ROS Mode", command=lambda: set_mode("ROS"), height=5, width=10).grid(row=0, column=3, padx=10, pady=10)
    tk.Button(main_frame, text="Chats and Games", command=lambda: set_mode("CHAT_WITH_ME"), height=5, width=10).grid(row=1, column=3, padx=10, pady=10)
    tk.Button(main_frame, text="Picture Time", command=lambda: set_mode("TAKE_PICTURE"), height=5, width=10).grid(row=1, column=0, padx=10, pady=10)
    tk.Button(main_frame, text="Stop", command=stop_all, height=5, width=10).grid(row=1, column=1, padx=10, pady=10)
    tk.Button(main_frame, text="Back", command=create_menu, height=5, width=10).grid(row=1, column=2, padx=10, pady=10)
    
def home_menu():
    messagebox.showinfo("Info", "Please be sure that you abserve all the precautions to avoid injuries and damages")
    for widget in main_frame.winfo_children():
        widget.destroy()

    tk.Button(main_frame, text="PS4 Controller", command=lambda: set_mode("PS4_CONTROLLER"), height=5, width=10).grid(row=0, column=0, padx=10, pady=10)
    tk.Button(main_frame, text="Color Following", command=lambda: set_mode("COLOR_FOLLOW"), height=5, width=10).grid(row=0, column=1, padx=10, pady=10)
    tk.Button(main_frame, text="Free Roam", command=lambda: set_mode("FREE_ROAM"), height=5, width=10).grid(row=0, column=2, padx=10, pady=10)
    tk.Button(main_frame, text="ROS Mode", command=lambda: set_mode("ROS"), height=5, width=10).grid(row=0, column=3, padx=10, pady=10)
    tk.Button(main_frame, text="Chat with Me", command=lambda: set_mode("CHAT_WITH_ME"), height=5, width=10).grid(row=1, column=3, padx=10, pady=10)
    tk.Button(main_frame, text="Take Picture", command=lambda: set_mode("TAKE_PICTURE"), height=5, width=10).grid(row=1, column=0, padx=10, pady=10)
    tk.Button(main_frame, text="Stop", command=stop_all, height=5, width=10).grid(row=1, column=1, padx=10, pady=10)
    tk.Button(main_frame, text="Back", command=create_menu, height=5, width=10).grid(row=1, column=2, padx=10, pady=10)
...
def super_market_menu():
    messagebox.showinfo("Info", "Super Market menu is under construction")

def farm_menu():
    for widget in main_frame.winfo_children():
        widget.destroy()
    tk.Button(main_frame, text="Mapping", command=lambda: set_mode("Mapping"), height=5, width=10).grid(row=0, column=0, padx=10, pady=10)
    tk.Button(main_frame, text="Disinfect", command=lambda: set_mode("Disinfection"), height=5, width=10).grid(row=0, column=1, padx=10, pady=10)
    tk.Button(main_frame, text="Watering", command=lambda: set_mode("Watering"), height=5, width=10).grid(row=0, column=2, padx=10, pady=10)
    tk.Button(main_frame, text="Plant Health", command=lambda: set_mode("Plant_health"), height=5, width=10).grid(row=0, column=3, padx=10, pady=10)
    tk.Button(main_frame, text="Harvesting", command=lambda: set_mode("Harvesting"), height=5, width=10).grid(row=1, column=1, padx=10, pady=10)
    tk.Button(main_frame, text="Stop", command=stop_all, height=5, width=10).grid(row=1, column=1, padx=10, pady=10)
    tk.Button(main_frame, text="Back", command=create_menu, height=5, width=10).grid(row=1, column=2, padx=10, pady=10)
    
def disaster_menu():
    messagebox.showinfo("Info", "Disaster menu is under construction")
